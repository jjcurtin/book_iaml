...
Uplink to folder above html

- cleaning EDA:  [qmd](../application_assignments/unit_02/hw_unit_2_cleaning.qmd) 
- modeling EDA: [qmd](../application_assignments/unit_02/hw_unit_2_modeling.qmd)

Test folder with _ in name

- cleaning EDA:  [qmd](_application_assignments/unit_02/hw_unit_2_cleaning.qmd) 
- modeling EDA: [qmd](_application_assignments/unit_02/hw_unit_2_modeling.qmd)

Direct link to docs folders

- cleaning EDA:  [qmd](docs/_application_assignments/unit_02/hw_unit_2_cleaning.qmd) 
- modeling EDA: [qmd](docs/_application_assignments/unit_02/hw_unit_2_modeling.qmd)
- cleaning EDA:  [qmd](docs/application_assignments/unit_02/hw_unit_2_cleaning.qmd) 
- modeling EDA: [qmd](docs/application_assignments/unit_02/hw_unit_2_modeling.qmd)


Raw content link (WORKS)
