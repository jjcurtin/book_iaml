...
- Quiz - Don't forget
- Final concepts exam - Tuesday, May 5th @ 11 - 12:15 pm
- Final applications - Friday, May 8th at noon
- Review - Thursday
- Surgery - May 7
...
- Connection to model performance (why is college rank system ostensibly opaque)
...
# Post-discussion points on opacity and proxies

- When a measure becomes a target....
  - length of stay
  - token-maxing
  - steps (vs. biking, nordic skiing)
...
- Implications of including race/ethnicity as feature(s) in our models?
...
Can companies enact usage restrictions on gov?

- political question
- Companies understand capabilities


Gov collects massive unused data 

- We think protection from total surveillance provided by law
- In fact, provided by limited capabilities to analyze data. 8 million agents to analyze


Legal system predicated on imperfect enforcement of law

- many laws
- Very broad 
- Not enforced uniformly
- AI enables uniform enforcement of law 
- Fairness, bad actors ???


Systems have complex guardrails for alignment

- stalk girlfriend, build bomb
- aligned to ethics
- Aligned to (current) Gov 
- Philosophical, political aesthetic 
- Morality can’t be represented in list of rules
- Need to create a virtuous agent 
- Systems differ in guardrails and guardrails can reflect this of company (Elon vs Dario)


Supply chain risk as political assassination. 


For all AI Agent use, their needs to be a human that is legally/criminally liable.