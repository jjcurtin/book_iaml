...
::: {.callout-important collapse="false"}
### Question: Can you link the numbers in the confusion matrix to Sensitivity and Specificity metrics
```{html}
#| echo: true
#| code-fold: true
#| code-summary: "Show Answer"
...
::: {.callout-important collapse="false"}
### Question: Can you link the numbers in the confusion matrix to PPV and NPV metrics
```{html}
#| echo: true
#| code-fold: true
#| code-summary: "Show Answer"
...
|:--------------|:--------- |:----------|
| **Prediction**| Negative  | Positive  | 
| Negative      | 2397600   | 12000     |
| Positive      | 2400      | 588000    |
...
::: {.callout-important collapse="false"}
### Question: Can you link the numbers in the confusion matrix to Recall (Sensitivity) and Precision (PPV) metrics
```{html}
#| echo: true
#| code-fold: true
#| code-summary: "Show Answer"
