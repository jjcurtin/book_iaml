...
- Two weeks left!
  - next Tuesday (lab Jeopardy - concepts and code review)
  - next Thursday (discussion on applications)
  - following Tuesday (discussion on ethics/fairness)
  - following Thursday (concepts final exam review)

- Early start to final application assignment (assigned next Thursday, April 24th) and due Friday May 8th at noon 
- Concepts exam at lab time during finals period (Tuesday, May 5th, 11-12:15 in this room)

- PSA on LLMs and their use
...
IDF = log(number of documents in corpus divided by number of documents containing the word/term) + 1

- approaches 1 (e.g., log(1) + 1) for words that are in all documents
...
word2vec (google) for embeddings; see [book appendix](https://jjcurtin.github.io/book_iaml/app_word2vec.html)
  - skipgram
  - CBOW
...
Packages (from Posit) for using LLMs for prediction models and integrating LLMs into workflows in R are rapidly developing

- [mall](https://mlverse.github.io/mall/); [Posit tutorial video](https://www.youtube.com/watch?v=ZNHNVWUMTJA)
- [ellmer](https://ellmer.tidyverse.org/index.html); [Altman/Posit blog](https://posit.co/blog/generate-data-with-an-llm-and-ellmer); 