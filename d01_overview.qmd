...
[Examples of valuable prediction without explanation?]{.uwred}
...
[Supervised vs. unsupervised machine learning?]{.uwred}


[Supervised regression vs classification?]{.uwred}

--------------------------------------------------------------------------------

## Data Generating Process

[What is a data generating process?]{.uwred}
...
[Why do we estimate the data generating process?]{.uwred}

--------------------------------------------------------------------------------

## Cross Validation

[What is it and why do we do it?]{.uwred}


[How are replication and cross-validation different?]{.uwred}
...
[What are the **three general steps** by which we estimate and evaluate the data generating process with a sample of data?  Lets use all this vocabulary!]{.uwred}
...
[What is underfitting, overfitting, bias, and variance?]{.uwred}
...
::: {.callout-important}
# Question: Consider example  p = n in general linear model.  What happens in this situation?  How is this related to overfitting and model flexibility?
:::
