...
- [Lecture 2: Best Practices and Other Recommendations](https://mediaspace.wisc.edu/media/iaml+2-2/1_nxtr5uda)
- [Lecture 3: EDA for Data Cleaning]()
- [Lecture 4: EDA for Modeling - Univariate]()
...
- [data](ames_raw_class.csv)
- [data dictionary](ames_data_dictionary.pdf)
- cleaning EDA:  [rmd](hw_unit_2_cleaning.Rmd) 
- modeling EDA: [rmd](hw_unit_2_modeling.Rmd)
...
Note that we re-class all character variables as factors
