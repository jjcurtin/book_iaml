...
Submit the application assignment [here](https://canvas.wisc.edu/courses/395546/assignments/2187687) and complete the [unit quiz](https://canvas.wisc.edu/courses/395546/quizzes/514049) by 8 pm on Wednesday, January 31st
...
3. As part of the prepping process, `prep()` calculates and saves the features for the training data for later use
