...
* Use the function `slice_sample()` with `n` set to 20 to get a random subset of participants. Don't forget to set a seed first. Remember you can type `?slice_sample()` into your console to learn more about a function. 
