...
* Wickham, H. & Grolemund, G.  [-@RDS]. R for Data Science: Import, Tidy, Transform, Visualize, and Model Data (1st ed.). Sebastopol, CA: O’Reilly Media, Inc. ([website](https://r4ds.had.co.nz/)) 

* Hvitfeldt, E. & Silge, J.. [-@SMLTAR] Supervised Machine Learning for Text Analysis in R ([website](https://smltar.com/))
...
* Kuhn, M., & Johnson, K. [-@FES]. Feature Engineering and Selection: A Practical Approach for Predictive Models (1 edition). Boca Raton, FL: Chapman and Hall/CRC. ([website](http://www.feat.engineering/))

* Kuhn, M. & Silge, J. [-@TID] Tidy Modeling with R. ([website](https://www.tmwr.org/))

* Molnar, C. [-@IML] Intepretable Machine Learning: A Guide for Makiong Black Box Models Explainable. [website](https://christophm.github.io/interpretable-ml-book/)

* Silge, J., & Robinson, D. [-@TMR]. Text Mining with R: A Tidy Approach (1rst ed.). Beijing; Boston: O’Reilly Media. ([website](https://www.tidytextmining.com/)) 

* Wickham, H. [-@TSG].  The Tidy Style Guide. ([website](https://style.tidyverse.org/index.html))
