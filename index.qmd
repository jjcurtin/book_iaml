...
Office hours: Thursdays, 2- 3 pm or by appointment in room 326
...
Office hours:  Tuesdays 1:30 - 2:30 pm or by appointment in room 617
...
Final project is due during exam week (May 11th at 5 pm)
...
* James, G., Witten, D., Hastie, T., & Tibshirani, R. [-@ISL]. An Introduction to Statistical Learning: With Applications in R (2021; 2nd Edition). ([website](https://www.statlearning.com/)) 


We will also read sections to chapters in each of the following texts:

* Wickham, H. & Grolemund, G.  [-@RDS]. R for Data Science: Import, Tidy, Transform, Visualize, and Model Data (1st ed.). Sebastopol, CA: O’Reilly Media, Inc. ([bookdown](https://r4ds.had.co.nz/)) 

* Hvitfeldt, E. & Silge, J.. [-@SMLTAR] Supervised Machine Learning for Text Analysis in R ([bookdown](https://smltar.com/))

* Kuhn, M. & Johnson, K. [-@APM].  Applied Predictive Modeling. New York, NYL Springer Science. ([pdf](https://vuquangnguyen2016.files.wordpress.com/2018/03/applied-predictive-modeling-max-kuhn-kjell-johnson_1518.pdf))

* Kuhn, M., & Johnson, K. [-@FES]. Feature Engineering and Selection: A Practical Approach for Predictive Models (1 edition). Boca Raton, FL: Chapman and Hall/CRC. ([bookdown](http://www.feat.engineering/))

* Kuhn, M. & Silge, J. [-@TID] Tidy Modeling with R. ([bookdown](https://www.tmwr.org/))

* Molnar, C. [-@IML] Intepretable Machine Learning: A Guide for Makiong Black Box Models Explainable. [bookdown](https://christophm.github.io/interpretable-ml-book/)

* Silge, J., & Robinson, D. [-@TMR]. Text Mining with R: A Tidy Approach (1rst ed.). Beijing; Boston: O’Reilly Media. ([bookdown](https://www.tidytextmining.com/)) 


* Wickham, H. [-@TSG].  The Tidy Style Guide. ([bookdown](https://style.tidyverse.org/index.html))
...
The midterm application exam will be due during the 7th week of the course on Wednesday, March 10th at 8 pm.
The midterm conceptual exam will be administered during class on Thursday, March 11th.

The final conceptual exam will be administered during class on Thursday, My 4th.
The final application exam will be due during the exam period on Tuesday, May 9th at 8 pm.
